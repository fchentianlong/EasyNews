...
import codeword.com.easynews.module.photo.presenter.IPhotoDetailPresenter;
import codeword.com.easynews.module.photo.presenter.IPhotoDetailPresenterImpl;
import codeword.com.easynews.module.photo.view.IPhotoDetailView;
import codeword.com.easynews.module.video.adapter.OnPageChangeListenerAdapter;
import codeword.com.easynews.module.video.adapter.PhotoDetailAdapter;
import codeword.com.easynews.utils.MeasureUtil;
import codeword.com.easynews.widget.HackyViewPager;
...
public class PhotoDetailActivity extends BaseActivity<IPhotoDetailPresenter> implements IPhotoDetailView{
    ...
    @Override
    public void initViewPager(SinaPhotoDetail photoList) {
        mOffset= MeasureUtil.getScreenSize(this).y/4;
        mTitleTv.setText(photoList.data.title);
        mTitleTv.setTag(true);

        final PhotoDetailAdapter photoAdapter=new PhotoDetailAdapter(this,photoList.data.pics);
        ...
        photoAdapter.setOnPhotoExpandListener(new PhotoDetailAdapter.OnPhotoExpandListener() {
            @Override
